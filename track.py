...
def detect(opt):
	...
	for frame_idx, (path, img, im0s, vid_cap) in enumerate(dataset):
		...
		for i, det in enumerate(pred):  # detections per image
			...
			bottomLeftCornerOfText = (im0.shape[1]-250,100)
			fontScale              = 2
			fontColor              = (10,10,255)
			lineType               = 4

			cv2.putText(im0,str(len(labelStoreVec)),
													 bottomLeftCornerOfText, 
																	   font, 
																  fontScale,
																  fontColor,
																   lineType)
			bottomLeftCornerOfText = (im0.shape[1]-1100,100)
			fontScale              = 1.5
			fontColor              = (0,0,0)
			lineType               = 4

			cv2.putText(im0,"ChimeraMultimedia",
													 bottomLeftCornerOfText, 
																	   font, 
																  fontScale,
																  fontColor,
...
if __name__ == '__main__':
	...
	parser.add_argument('--img-size', type=int, default=1288, help='inference size (pixels)')
	parser.add_argument('--conf-thres', type=float, default=0.68, help='object confidence threshold')
